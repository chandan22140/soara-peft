...
#   --task obqa --method v1 --lora_rank 128 \
#   --epochs 3 --learning_rate 1e-4 --real_batch_size 16 \
#   --per_device_batch_size 16 --max_length 512 --s_lr_multiplier 10 > logs/obqa_cmd1.log 2>&1

# echo "=== COMMAND 2: SOARA-V2a (r=None, givens) ==="
# python train_llama_commonsense_temp.py \
#   --task obqa --method V2 --lora_rank 128 \
#   --use_butterfly False --butterfly_sequential False \
#   --epochs 3 --learning_rate 1e-4 --real_batch_size 16 \
#   --per_device_batch_size 16 --max_length 512 \
#   --total_cycles 3 --s_lr_multiplier 10 > logs/obqa_cmd2.log 2>&1
...
python train_llama_commonsense_temp.py \
  ...
  --epochs 3 --learning_rate 1e-4 --real_batch_size 16 \
  --per_device_batch_size 16 --max_length 512 \
  --total_cycles 3 --s_lr_multiplier 10 > logs/obqa_cmd3.log 2>&1

echo "All 3 obqa experiments completed successfully!"